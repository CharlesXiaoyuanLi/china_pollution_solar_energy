...
prov_pwden_djf = fh.variables['prov_pwden_djf'][:][:]
prov_pwden_mam = fh.variables['prov_pwden_mam'][:][:]
prov_pwden_jja = fh.variables['prov_pwden_jja'][:][:]
prov_pwden_son = fh.variables['prov_pwden_son'][:][:]
...
#            color='tomato',rwidth=0.8)
    ...
    plt.savefig('./Figures/season_freq/1Davg/'+province+'_1Davg_Freq_4seasons_aero_pwden',format='ps')
    plt.close()
