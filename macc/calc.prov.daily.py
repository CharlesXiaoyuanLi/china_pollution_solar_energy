### This program calculates daily mean data,
...
# Open netCDF file
    ...
    ntime = time.size
    time_units = fh.variables['t'].units
...
# write to large array
    if year%4 == 0: 
        prov_pwden[pos_time:pos_time+366,:] = pro_powerden
        dim_time[pos_time:pos_time+366] = time + pos_time
        pos_time += 366
    else:
        prov_pwden[pos_time:pos_time+365,:] = pro_powerden
        dim_time[pos_time:pos_time+365] = time + pos_time
        pos_time += 365

### Write the data to ncfile
outfile = Dataset('prov.daily.powerden.nc','w',format='NETCDF4')
...
time_dim[:]   = dim_time
time_dim.units = 'days since 2003-01-01 00:00:00'
